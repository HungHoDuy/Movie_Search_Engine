...
unique_genres = [item.lower() for item in unique_genres]
unique_language = [item.lower() for item in unique_language]
unique_production_companies = [item.lower() for item in unique_production_companies]
unique_belongs_to_collection = [item.lower() for item in unique_belongs_to_collection]
unique_production_countries = [item.lower() for item in unique_production_countries]
