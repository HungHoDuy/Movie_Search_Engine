...
def preprocess_movie_data(file_path):
    ...
    df["genres"] = df["genres"].apply(
        lambda genres: ",".join([genre["name"] for genre in genres])
    ...
    df["production_companies"] = df["production_companies"].apply(
        lambda companies: ",".join([company["name"] for company in companies])
    ...
    df["production_countries"] = df["production_countries"].apply(
        lambda countries: ",".join([country["name"] for country in countries])
